...
// const columnList = [
//   [
//     '时间',	'当前网银线路总带宽使用率(%)',	'网银线路总带宽同期均值使用率(5日)(%)',	'上期网银线路总带宽使用率(%)'
//   ],
//   [
//     '时间',	'当前手机银行应用总带宽使用率(%)',	'手机银行应用同期均值总带宽使用率(5日)(%)',	'上期手机银行应用总带宽使用率(%)'
//   ],
//   [
//     '时间',	'当前张江网银移动互联网专线手机银行应用使用量(M)',	'张江网银移动互联网专线手机银行应用同期均值使用量(5日)(M)',	'上期张江网银移动互联网专线手机银行应用使用量(M)'
//   ]
// ]
